...
function emptyClient(): ClientInfo {
    return { id: crypto.randomUUID(), nom: "", telephone: "", adresse: "", typeClient: "", produitsHabituels: "", frequenceAchat: "", montantMoyen: "", modePaiement: "", plafondAutorise: "", garant: "", moyenGaranti: "", garantContact: "", montantGaranti: "", profession: "", fiabilite: "", notes: "" };
}
...
export default function SectionDetailView({ project, onBack, onSave }: SectionDetailViewProps) {
    ...
    const hasExistingData = !!(project.info.section2Completed || (project.info.name && project.info.sector && project.info.description));
    const [showSummary, setShowSummary] = useState(hasExistingData);
