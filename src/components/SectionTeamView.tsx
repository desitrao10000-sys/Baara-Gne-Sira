...
import { Project, ProjectManager } from "@/lib/useSupabaseProjects";
import ProjectManagerSection from "./ProjectManagerSection";

interface SectionTeamViewProps {
    project: Project;
    onBack: () => void;
    onSaveManager: (manager: ProjectManager | null) => void;
}

export default function SectionTeamView({ project, onBack, onSaveManager }: SectionTeamViewProps) {
    return (
